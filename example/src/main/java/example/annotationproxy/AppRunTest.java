package example.annotationproxy;

import example.annotationproxy.service.api.UserQueryAPI;
...
public class AppRunTest {
    public static void main(String[] args) {
        ApplicationContext ctx = new ClassPathXmlApplicationContext("classpath:example/annotationproxy/spring.xml");
