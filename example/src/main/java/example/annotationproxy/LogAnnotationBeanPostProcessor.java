...
import example.annotationproxy.handler.IHandler;
import example.annotationproxy.handler.LogHandler;
import example.annotationproxy.handler.MyInvocationHandler;
