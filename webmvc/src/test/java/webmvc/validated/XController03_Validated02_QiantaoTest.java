...
public class XController03_Validated02_QiantaoTest {
    ...
    public void testList01() throws Exception{
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.post("/validatedQiantao/add");
    ...
    public void testList02() throws Exception{
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.post("/validatedQiantao/add");
        request.param("name","java");
        request.param("rightForm.r","java");
        MvcResult mvcResult = mockMvc.perform(request)
                .andReturn();
        String content = mvcResult.getResponse().getContentAsString();
        println2(content);
