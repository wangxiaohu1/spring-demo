...
public class XController03_ValidatedTest {
    ...
    public void testList01() throws Exception{
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/validated/add"))
                .andReturn();
    ...
    public void testList02() throws Exception{
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.post("/validated/add");
